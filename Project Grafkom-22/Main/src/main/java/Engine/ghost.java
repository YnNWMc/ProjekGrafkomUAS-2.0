...
public class ghost extends Sphere{
    ...
    public ghost(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, double r, ArrayList<Float> centerPoint, float rX, float rY, float rZ, int stackCount, int sectorCount, Model m) {
        super(shaderModuleDataList, vertices, color, r, centerPoint, rX, rY, rZ, stackCount, sectorCount, m);
    }


    public void move(String direction, ghost p)
    {
